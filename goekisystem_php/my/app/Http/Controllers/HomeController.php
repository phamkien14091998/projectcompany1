...
class HomeController extends Controller {
	...
	*/
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.user.index')->with(['r' => $request, 'data' => $api_result]);
    }
    ...
    public function detailUser(Request $request){
        ...
        $pathMyLogin = ConstantHelper::$DOMAIN_MY.ConstantHelper::$USER_LIST;
        $api_result = $api->getListUser($pathMyLogin, $array);
        return view('pages.user.detail_user')->with(['r' => $request, 'data' => $api_result]);
    }
    ...
    public function detailUserForm(Request $request){
        ...
        return view('pages.user.detail_user_form')->with(['data' => $api_result]);
    }
    ...
    public function rankUser(Request $request){
        ...
        $pathMyLogin = ConstantHelper::$DOMAIN_MY.ConstantHelper::$USER_LIST;
        $api_result = $api->getListUser($pathMyLogin, $array);
        return view('pages.user.detail_star_level')->with(['r' => $request, 'data' => $api_result]);
    }
