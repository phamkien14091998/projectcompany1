...
<head>
	...
	<title>@yield('title')</title>
		 ...
		 <!-- CSS in schdule -->
		 <!-- <link href="{{ asset('/css/showlist-girl.css') }}" rel="stylesheet"> 
		 <link href="{{ asset('/css/list-girl.css') }}" rel="stylesheet"> -->
						...
						<div class="text-center">
							<div id="bg-hearder" class="col-md-12">
								<div class="col-md-12">
									...
									<div class="col-md-2">
										<button type="button" style="margin-right: 200px"  class="bt col-md-7 btn">Search log</button>
									</div>
									<br><br><br>
								</div>
							</div>
